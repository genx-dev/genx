...
class Parameters:
    ...
    def write_h5group(self, group):
        ...
        :return:
        """
        group['data_labels'] = np.array(self.data_labels, dtype='S')
    ...
    def read_h5group(self, group):
        ...
        :return:
        """
        self.data_labels = [item.decode('latin1') for item in list(group['data_labels'].value)]
        self.data = [[c0.decode('latin1'), float(c1), bool(c2), float(c3), float(c4), c5.decode('latin1')] for (c0, c1, c2, c3, c4, c5) in
