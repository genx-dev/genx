...
import genx.plugins.add_ons.help_modules.model_interactors as mi
import genx.plugins.add_ons.help_modules.atom_viewer as atom_viewer
...
class Plugin(framework.Template):
    ...
    def setup_script_interactor(self, model_name='sxrd2'):
        ...
        model = __import__('genx.models.%s' % model_name, globals(), locals(), [model_name])
        preamble = "import genx.models.%s as model\nfrom genx.models.utils import UserVars\nfrom genx.models.symmetries import *\n" % model_name
