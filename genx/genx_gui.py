...
class MainFrame(wx.Frame):
    def __init__(self, parent, show_startup, *args, **kwds):
        ...
        kwds["style"] = (wx.CAPTION | wx.CLOSE_BOX | wx.MINIMIZE_BOX | wx.MAXIMIZE_BOX | wx.SYSTEM_MENU
                         | wx.RESIZE_BORDER | wx.FULL_REPAINT_ON_RESIZE)
        wx.Frame.__init__(self, *args, **kwds)
        
        self.ver_splitter = wx.SplitterWindow(self, -1, style=wx.SP_LIVE_UPDATE | wx.FULL_REPAINT_ON_RESIZE)
        self.hor_splitter = wx.SplitterWindow(self.ver_splitter, -1, style=wx.SP_LIVE_UPDATE | wx.FULL_REPAINT_ON_RESIZE)
        ...
        self.data_notebook = wx.Notebook(self.ver_splitter, -1, style=wx.NB_BOTTOM|wx.NO_BORDER)
        ...
        self.main_frame_toolbar = self.CreateToolBar(wx.TB_HORIZONTAL|wx.TB_FLAT)
        ...
        # Tool Bar end
        self.data_list = genx.datalist.DataListControl(self.data_notebook, -1, self.config, status_text)
        ...
        self.Bind(genx.solvergui.EVT_SOLVER_UPDATE_TEXT, self.eh_ex_status_text)
        self.Bind(genx.solvergui.EVT_UPDATE_PARAMETERS, self.paramter_grid.OnSolverUpdateEvent)
        self.Bind(genx.solvergui.EVT_UPDATE_PARAMETERS, self.plot_pars.OnSolverParameterEvent)
        # For picking a point in a plot
        self.Bind(genx.plotpanel.EVT_PLOT_POSITION, self.eh_ex_point_pick)
        ...
        self.Bind(genx.plotpanel.EVT_PLOT_SETTINGS_CHANGE,  self.eh_ex_plot_settings_changed)

        # Binding events which means model changes
        self.Bind(genx.parametergrid.EVT_PARAMETER_GRID_CHANGE, self.eh_external_model_changed)
        self.Bind(wx.stc.EVT_STC_MODIFIED, self.eh_external_model_changed, self.script_editor)
        self.Bind(genx.datalist.EVT_DATA_LIST, self.eh_external_model_changed, self.data_list.list_ctrl)

        # Event for when a value of a parameter in the parameter grid has been updated
        self.Bind(genx.parametergrid.EVT_PARAMETER_VALUE_CHANGE, self.eh_external_parameter_value_changed)
        ...
        #self.main_frame_toolbar.Update()
        #### End Manual config
    ...
    def __set_properties(self):
        ...
        self.main_frame_fom_text = wx.StaticText(self.main_frame_toolbar, wx.NewId(),\
            '        FOM:                    ', size = (400, -1))
...
#        self.hor_splitter.SetMinimumPaneSize(1)
    ...
    def __do_layout(self):
        ...
        self.data_notebook.AddPage(self.data_list, "Data")
        ...
        self.ver_splitter.SplitVertically(self.data_notebook, self.hor_splitter)
    ...
    def LayoutSplitters(self):
         ...
         self.ver_splitter.SetSashGravity(0.75)
    ...
    def eh_tb_open(self, event): # wxGlade: MainFrame.<event_handler>
        ...
        self.Refresh()
        self.Update()
        self.main_frame_toolbar.Refresh()
        self.main_frame_toolbar.Update()
        #genx.event_handlers.open(self, event)
...
class MyApp(wx.App):
    ...
    def OnInit(self):
        ...
        self.locale = locale
        display_size = wx.DisplaySize()
        main_frame = MainFrame(self, self.show_startup, None, -1, "", size=(display_size[0]*0.85, display_size[1]*0.9))
        self.SetTopWindow(main_frame)
        main_frame.LayoutSplitters()
        main_frame.CenterOnScreen()
        main_frame.Show()
        main_frame.SendSizeEvent()
        main_frame.SendSizeEvent()
        #display_size = wx.DisplaySize()
        #main_frame.SetSize((display_size[0]*0.85, display_size[1]*0.9))
        #main_frame.CenterOnScreen()
