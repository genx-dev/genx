...
def create_string(str_or_bstring):
    '''Assures  that a string is returned. Handles a bug in h5py'''
    if isinstance(str_or_bstring, bytes):
        return str_or_bstring.decode()
    else:
        return str_or_bstring
